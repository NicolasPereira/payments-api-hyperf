...
- Documento com todos dígitos iguais (ex: `00000000000`, `11111111111`, `00000000000000`; para CNPJ alfa, sequências com mesmo char repetido ex: `AAAAAAAAAAAAAAAA`, `11111111111111`, `AAAAAAAAAAAA00`) → 422 mesmo que DV coincida (regra estendida para CNPJ alfa per `FR-021`).
